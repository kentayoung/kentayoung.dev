  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <a
            id="linkedIn-KentaYoung"
            href="https://www.linkedin.com/in/kentayoung"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            id="instagram-KentaYoung"
            href="https://www.instagram.com/kenta_young/"
            target="_blank"
            rel="noreferrer"
            className="icon-circle"
          >
          ...
          <a
            id="facebook-KentaYoung"
            href="https://www.facebook.com/kentayoungphotography"
            target="_blank"
            rel="noreferrer"
            className="icon-circle"
          >
          ...
          <a
            id="github-KentaYoung"
            href="https://github.com/kentayoung"
            target="_blank"
            rel="noreferrer"
            className="icon-circle"
          >
